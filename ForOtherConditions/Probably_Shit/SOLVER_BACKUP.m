...
pivot = 0.3;
% ONLY LEADING EDGE?
onlyLE = 1; % 0 - STANDARD FLAPPING | 1 - LEADING-EDHE | 2 - FLAP
smoother = 117.7;
...
%                         end
                        ...
                        for k = 1:NTS
                            ...
                            ALPHA_1 = -(AMP_AL*sin(2*pi*freq*dt*k)-AoA); %POSITIVE UP
                            ALPHA_2 = -(AMP_AL_2*sin(2*pi*freq*dt*k)-AoA); %POSITIVE UP
                            ...
                            for i = 1:N+1
                                ...
                                elseif onlyLE == 1
                                    AMP_AL_1 = 1/(1+exp(smoother*(x_wd(i)/chord)))*AMP_AL;
                                ...
                                elseif onlyLE == 2
                                    AMP_AL_11 = 1/(1+exp(-smoother*(x_wd(i)/chord)))*AMP_AL_2;
